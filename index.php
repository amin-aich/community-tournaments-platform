...
?>
    ...
    <main id="app-root" class="container" role="main" tabindex="-1">
        <?php
        // Optional: server-rendered initial content for SEO / no-JS,
        // e.g. include __DIR__ . '/leaderboard.php' or keep empty.
        // We'll include a small initial fragment for first paint:
        // include $prevFolder . 'fragment/leaderboard.php'; // safe: fragment returns inner HTML only
        ?>
